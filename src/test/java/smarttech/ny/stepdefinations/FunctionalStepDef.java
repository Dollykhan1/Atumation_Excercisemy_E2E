...
import smarttech.ny.elementpage.MasterPageFactory;

public class FunctionalStepDef extends BasePage  {
...
//      String text = driver.findElement(By.xpath("//*[text(1)=' Home']")).getText(1);
...
//	}
	...
	pf.getLogin(prop.getProperty("UserName"),prop.getProperty("pasword"));
